...
class PlusMaze(object):
    ...
    # HARDWARE SETTINGS
    #------------------------------------------------------------
    gate_settings = {'north': GateSetting(epaddr=0x02, cl=575, op=1200),
    ...
    dose_settings = {'TRIG_EPADDR': 0x40,
                     ...
                     'east' : DoseSetting(trig_bit=4, epaddr=0x07, dose_vol=15500, dose_rep=30),
                     'south': DoseSetting(trig_bit=1, epaddr=0x04, dose_vol=12500, dose_rep=7),
                     'north': DoseSetting(trig_bit=3, epaddr=0x06, dose_vol=19500, dose_rep=7),
                     'west' : DoseSetting(trig_bit=2, epaddr=0x05, dose_vol=19000, dose_rep=10)}
