...
class PlusMaze(object):
    ...
    dose_settings = {'TRIG_EPADDR': 0x40,
                     ...
                     'east' : DoseSetting(trig_bit=1, epaddr=0x04, dose_vol=13500, dose_rep=3),
                     'south': DoseSetting(trig_bit=2, epaddr=0x05, dose_vol=16000, dose_rep=1),
                     'north': DoseSetting(trig_bit=3, epaddr=0x06, dose_vol=15500, dose_rep=2),
                     'west' : DoseSetting(trig_bit=4, epaddr=0x07, dose_vol=16000, dose_rep=2)}
