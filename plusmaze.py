...
class PlusMaze(object):
    ...
    dose_settings = {'TRIG_EPADDR': 0x40,
                     ...
                     'east' : DoseSetting(trig_bit=4, epaddr=0x07, dose_vol=15000, dose_rep=3),
                     'south': DoseSetting(trig_bit=1, epaddr=0x04, dose_vol=17000, dose_rep=4),
                     'north': DoseSetting(trig_bit=3, epaddr=0x06, dose_vol=15000, dose_rep=3),
